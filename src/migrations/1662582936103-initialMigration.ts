...
export class initialMigration1662582936103 implements MigrationInterface {
    name = 'initialMigration1662582936103'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sessions" ("session_id" uuid NOT NULL, "date" date NOT NULL, "hour" TIME NOT NULL, "clubId" uuid, CONSTRAINT "PK_9340188c93349808f10d1db74a8" PRIMARY KEY ("session_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "clubs" ("id" uuid NOT NULL, "name" character varying(50) NOT NULL, "description" character varying(300) NOT NULL, "isActive" boolean NOT NULL, "created_At" TIMESTAMP NOT NULL DEFAULT now(), "admId" uuid, CONSTRAINT "PK_bb09bd0c8d5238aeaa8f86ee0d4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "sessions" ADD CONSTRAINT "FK_e4f2e676febd48b5e5cd4ae0acf" FOREIGN KEY ("clubId") REFERENCES "clubs"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
