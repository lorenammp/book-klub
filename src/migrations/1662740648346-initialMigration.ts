...
export class initialMigration1662740648346 implements MigrationInterface {
    name = 'initialMigration1662740648346'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "meetings" ("id" uuid NOT NULL, "date" date NOT NULL, "hour" TIME NOT NULL, "clubId" uuid, CONSTRAINT "PK_aa73be861afa77eb4ed31f3ed57" PRIMARY KEY ("id"))`);
